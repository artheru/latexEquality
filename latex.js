...
*/
var parser = (function(){
var o=function(k,v,o,l){for(o=o||{},l=k.length;l--;o[k[l]]=v);return o},$V0=[1,6],$V1=[1,7],$V2=[1,4],$V3=[1,11],$V4=[5,7,9,10,11];
var parser = {trace: function trace() { },
yy: {},
symbols_: {"error":2,"deBracelet":3,"sequence":4,"EOF":5,"ctrl":6,"CONTROL":7,"subSequence":8,"{":9,"}":10,"CHAR":11,"$accept":0,"$end":1},
terminals_: {2:"error",5:"EOF",7:"CONTROL",9:"{",10:"}",11:"CHAR"},
productions_: [0,[3,2],[6,1],[8,3],[8,2],[4,1],[4,1],[4,1],[4,2],[4,2],[4,2]],
...
case 2:
			...
			this.$=function(){
				var type=$$[$0].replace("\\","").toLowerCase();
...
case 4:
			...
			this.$=function(){return {type:"sub", seq:""}; };
...
case 6:
			...
			this.$=function(current){
				current.cm.slice(-1)[0](current, {type:"char", seq:$$[$0]});
			};
...
case 7:
			...
			this.$=function(current){
				current.cm.slice(-1)[0](current, $$[$0]());
			};
...
table: [{3:1,4:2,6:3,7:$V0,8:5,9:$V1,11:$V2},{1:[3]},{5:[1,8],6:10,7:$V0,8:9,9:$V1,11:$V3},o($V4,[2,5]),o($V4,[2,6]),o($V4,[2,7]),o($V4,[2,2]),{4:12,6:3,7:$V0,8:5,9:$V1,10:[1,13],11:$V2},{1:[2,1]},o($V4,[2,8]),o($V4,[2,9]),o($V4,[2,10]),{6:10,7:$V0,8:9,9:$V1,10:[1,14],11:$V3},o($V4,[2,4]),o($V4,[2,3])],
